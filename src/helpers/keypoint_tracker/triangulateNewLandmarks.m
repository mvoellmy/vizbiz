...
updateConsole(params,...
              ...
              nnz(bearing_angle_deg < bearing_angle_low_thr),...
              nnz(bearing_angle_deg > bearing_angle_up_thr),...
              nnz(kp_tracks_updated.nr_trackings < params.kp_tracker.min_nr_trackings)));
