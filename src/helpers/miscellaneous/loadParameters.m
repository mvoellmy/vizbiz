...
%
% Note: important parameters marked with <===
...
params.boot.landmarks_cutoff = 200;
...
params.init.figures = false; % on/off figure
...
if params.ds == 0
    ...
    params.localization_ransac.num_iterations_pnp = 1000; % 2000 % <===
    ...
    params.kp_tracker.max_nr_candidates = 2500; % <===
    ...
    params.kp_tracker.bearing_up_thr = params.kp_tracker.bearing_low_thr*10; % [deg]
...
elseif params.ds == 1
    ...
    params.localization_ransac.num_iterations_pnp = 3000; % 2000
...
elseif params.ds == 2
    ...
    params.localization_ransac.num_iterations_pnp = 2000; % 2000
