...
The pipeline consists mainly of two parts, its initialisation and its continuous operation. Both of them are discussed within the two following sections.
