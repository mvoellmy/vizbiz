...
\subsubsection{Run time characteristics}
...
\begin{figure*}[ht!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=2.7in]{results/trajectory_poly_up.eps}
        \caption{Trajectory vs. ground truth}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
        \includegraphics[height=2.7in]{results/landmarks_poly_up.eps}
        \caption{3D landmarks}
    \end{subfigure}
...
%    \begin{subfigure}[t]{0.5\textwidth}
%        \centering
%        \includegraphics[height=2.7in]{results/trajectory_poly_down.eps}
%        \caption{Trajectory vs. ground truth}
%    \end{subfigure}%
%    ~ 
%    \begin{subfigure}[t]{0.5\textwidth}
%        \centering
%        \includegraphics[height=2.7in]{results/landmarks_poly_down.eps}
%        \caption{3D landmarks}
%    \end{subfigure}
